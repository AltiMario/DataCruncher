...
_message = { 
    ...
    "adminHelpMessage": "The firewall listens coming data streams through many different services.<br/>Activating only those that are strictly needed.",    "version": "<strong>Version </strong>",

 ...
 * </p>
 *
 * @version $Revision: 1128458 $ $Date: 2011-05-27 23:11:39 +0200 (ven, 27 mag 2011) $
 * @since Validator 1.4
 */
...
public class Domain implements SingleValidation, Serializable {
     ...
     */
    private static final Domain DOMAIN_VALIDATOR = new Domain(false);

    /**
     * Singleton instance of this validator, which does
     *  consider local addresses valid.
     */
    private static final Domain DOMAIN_VALIDATOR_WITH_LOCAL = new Domain(true);

    /**
     * Regex for matching domains.
     */
    private final Regex domainRegex =
            new Regex(DOMAIN_NAME_REGEX);
    /**
     * Regex for matching the a local hostname
     */
    private final Regex hostnameRegex =
            new Regex(DOMAIN_LABEL_REGEX);
     ...
     * @return the singleton instance of this validator
     */
    public static Domain getInstance(boolean allowLocal) {
        if(allowLocal) {
            return DOMAIN_VALIDATOR_WITH_LOCAL;
        }
    ...
    /** Private constructor. */
    private Domain(boolean allowLocal) {
    ...
    public ResultStepValidation checkValidity(String domain){
        ...
        try{
            if(isValid(domain)){
                ...
                result.setMessageResult("Domain name: [" + domain + "] wrong.");

            }
        }catch(Exception e)  {
            result.setValid(false);
            result.setMessageResult("Domain name: [" + domain + "] wrong. " +e.getMessage());
        }
        return result;
    }
    /**

...
import com.datacruncher.jpa.entity.*;
import com.datacruncher.utils.schema.JaxbGenerationResults;
import com.datacruncher.utils.schema.SchemaCodeGenerator;
...
public class XSDFieldStorer implements DaoSet {
        ...
        if (result.isValid()){
            try {
                ...
                if (isXSDInvalid) {
                    ...
                    XSDFieldImporter.XsdSchemaFieldInfo schemaFieldInfo;
                    try{
    ...
    private  void saveSchemaFieldInfo(XSDFieldImporter.XsdSchemaFieldInfo schemaFieldInfo) {
        String name = "";
        try{
            result.setValid(true);
            result.setMessageResult("");

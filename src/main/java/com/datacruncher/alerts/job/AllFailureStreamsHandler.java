...
import com.datacruncher.alerts.AlertDispatcher;
import com.datacruncher.alerts.AlertsData;
...
public class AllFailureStreamsHandler extends AlertsDataHandler implements DaoSet {
	 ...
	 *
	 * @see
	 * com.datacruncher.alerts.AlertsDataHandler#handle(java.util.List)
	 */
	@Override

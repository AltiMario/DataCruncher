...
public class FileInfo {
    ...
    public static String GENERATED_PACKAGE = "com.datacruncher.generated.schema";
    public static String GENERATED_PATH = "com" + File.separator + File.separator + "datacruncher"

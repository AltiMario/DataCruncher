...
public class NumericFieldValuesCreateController implements Controller, DaoSet {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		out.write(mapper.writeValueAsBytes(numericFieldDao.create(numericFieldValuesEntity)));
		out.flush();
		out.close();
		return null;
	}

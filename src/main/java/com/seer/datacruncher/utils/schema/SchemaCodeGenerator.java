...
public class SchemaCodeGenerator implements DaoSet {
	...
	public JaxbGenerationResults generateJAXBStuffFromSchema(long schemaId, byte[] schemaCantaints) throws SchemaParsingException {
		...
		genarateSourceFromSchema(genLocation, FileInfo.GENERATED_PACKAGE + schemaId, schemaFile);
	 ...
	 * @throws IOException
	 */
	private void genarateSourceFromSchema(String genLocation, String genPackage, String schemaLocation) throws SchemaParsingException {

 ...
 * length and {@link com.seer.datacruncher.utils.validation.CheckDigit} validations.
 * <p>
 ...
 *   <li>Performs {@link com.seer.datacruncher.utils.validation.CheckDigit} validation on the parsed code (if specified).</li>
 * </ul>
 * <p>
 * Configure the validator with the appropriate regular expression, minimum/maximum length
 * and {@link com.seer.datacruncher.utils.validation.CheckDigit} validator and then call one of the two validation
 * methods provided:</p>
 *    <ul>

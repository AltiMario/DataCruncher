...
package com.seer.datacruncher.connection;

import com.jolbox.bonecp.BoneCP;
import com.jolbox.bonecp.BoneCPConfig;
import com.seer.datacruncher.jpa.dao.DaoSet;
import com.seer.datacruncher.jpa.entity.DatabaseEntity;
import com.seer.datacruncher.persistence.manager.DBConnectionChecker.JDBCDriver;
...
public class ConnectionPoolsSet implements DaoSet {
	...
	private static BoneCP createConnectionPool(final Long id) {
		...
		try {
			Class.forName(JDBCDriver.getJDBCDriverClassById(dbEntity.getIdDatabaseType()));

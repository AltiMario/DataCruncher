...
public class JobsDestroyController implements Controller, DaoSet {
	...
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		if(jobId != null && jobId.startsWith("/"))
		...
		out.write(mapper.writeValueAsBytes(jobsDao.destroy(Long
				.parseLong(jobId))));
		out.flush();
		out.close();
		plannerJobMap.delete(Long.parseLong(jobId));		
		return null;
	}
}
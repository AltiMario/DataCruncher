...
public class AlphanumericFieldValuesCreateController implements Controller, DaoSet {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		out.write(mapper.writeValueAsBytes(alphaFieldDao.create(alphanumericFieldValuesEntity)));
		out.flush();
		out.close();
		return null;
	}

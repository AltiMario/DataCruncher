...
public class CustomErrorsCreateController implements Controller, DaoSet {
	...
	public ModelAndView handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		CustomErrorEntity errorEnt = mapper.readValue(json, CustomErrorEntity.class);
		ServletOutputStream out;
		response.setContentType("application/json");
		out = response.getOutputStream();
		out.write(mapper.writeValueAsBytes(customErrorsDao.create(errorEnt)));
		out.flush();
		out.close();
		return null;
	}

...
import com.seer.datacruncher.persistence.sources.TraceManager;
...
import com.seer.datacruncher.utils.entity.DummyBean;
...
public class QuickDBRecognizer {
	...
	private static final String dummyBeanPackageWithDot = "com.seer.datacruncher.utils.entity.";
	...
	public StreamToDbDynamicObject traceDefine(List<Element> xmlTextNodes) throws ReflectionException,
		...
		for (Map.Entry<String, EnrichedTraceField> ent : preparedSchemaFields.entrySet()) {
			...
			if (!insertedFields.containsKey(upperCaseFieldName)) {
				...
				Annotation annot = new Annotation("com.seer.datacruncher.conf.annotations.Column", constpool);
